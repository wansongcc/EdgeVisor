        ...
        try {
            ...
            if (op == "set_plan") {
                ...
                if (inference_ != nullptr) {
                    ...
                    bypass["rootApplyGeneration"] = inference_->getStageBypassAppliedGeneration();
                    bypass["verifiedGeneration"] = inference_->getStageBypassVerifiedGeneration();
